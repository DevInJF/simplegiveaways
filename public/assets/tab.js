...
(function() {
  ...
  jQuery(function() {
    var $auth, $auth_button, $auth_required, $authed, $autoshow, $email, $entry_id, $form, $form_submit, $just_liked, $like_id, $loader, $modal, $new_session, $referrer_id, $request_count, $send_count, $shortlink, $wall_post_count, Giveaway, fb_init_options, giveaway_hash, giveaway_object, paths, _sg;
    _sg = simpleGiveaways;
    ...
    $shortlink = null;
    $just_liked = false;
    $referrer_id = ("" + giveaway_hash.referrer_id) || "";
    ...
    $auth_required = function() {
      return giveaway_object.auth_required === "true";
    };
    $autoshow = function() {
      return giveaway_object.autoshow_share === "true";
    };
    $("#giveaway_image").click(function() {
      return Giveaway.modal.hide();
    });
    fb_init_options = {
      status: true,
      cookie: true,
    ...
    return Giveaway = {
      init: function() {
        FB.Canvas.setSize({
          height: "" + giveaway_hash.tab_height
        });
        FB.Event.subscribe('edge.create', function(href, widget) {
          $just_liked = true;
          Giveaway.step.one.hide();
          Giveaway.step.two.show();
          return Giveaway.onLike();
        });
        $("#enter_giveaway a").live("click", function(e) {
        ...
        Giveaway.step.two.find("a").live("click", function(e) {
          e.preventDefault();
          return Giveaway.entry.statusCheck();
        });
        return Giveaway.termsLink();
      },
      modal: $modal,
      step: {
      ...
      loader: $loader,
      termsLink: function() {
        return $("a.terms-link.terms-text").click(function(e) {
          $(".terms-text.hidden").show();
          FB.Canvas.setSize({
            height: $("#tab_container").height() + 40
          });
          return e.preventDefault();
        });
      },
      eligible: function() {
        var _ref;
        return (_ref = (("" + giveaway_hash.has_liked) === "true") || $just_liked) != null ? _ref : {
          "true": false
        };
      },
      onLike: function() {
      ...
      entry: {
        ...
        error: function(error) {
          ...
          return Giveaway.share.listener();
        },
        success: function() {
          $loader.hide();
          $form.hide();
          ...
          return $.ajax({
            ...
            statusCode: {
              ...
              406: function(response) {
                ...
                return $shortlink = $entry.shortlink;
              },
              412: function() {
                $loader.hide();
                return Giveaway.step.one.show();
              },
              404: function() {
                return Giveaway.entry.error("There was an unexpected error.<br />Please reload the page and try again.");
              },
              424: function() {
                return Giveaway.entry.error("There was an unexpected error.<br />Please reload the page and try again.");
              }
        ...
        statusCheck: function() {
          return FB.getLoginStatus(function(response) {
            if (response.authResponse && response.authResponse.accessToken) {
              ...
              return Giveaway.entry.eligible();
            } else if ($auth_required()) {
              return Giveaway.entry.auth(response);
            } else {
              return Giveaway.entry.form();
            }
          });
        },
        eligible: function() {
          Giveaway.entry.loader();
          if ($new_session != null) {
            return Giveaway.entry.submit($new_session);
          } else {
            return Giveaway.entry.statusCheck();
          }
        },
      ...
      share: {
        listener: function() {
          ...
          return $("a.raw-shortlink.btn-info").zclip({
        ...
        dialog: function(data) {
          return FB.ui(data, function(response) {
            var json;
            if (response && response.post_id) {
              ...
              return Giveaway.share.callback(json);
